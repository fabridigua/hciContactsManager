...
See [How it's is done](hciContactsManager/How%20it's%20done.md) for details on the architecture

See [installation guide](../blob/master/Installation%20Guide.md) 
