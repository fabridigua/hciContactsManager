...
<table>
    ...
    <tr>
        <td rowspan="2"><b>Contact persistence</b></td><td>You can save the current list of contacts by clicking in the floppy icon in the top bar</td><td><img src="imgs/save_session.png"/></td>
    </tr>
    <tr><td>Here you can delete the user</td><td><img src="imgs/delete_user_btn.png"/></td></tr>
    <tr>
</table>
