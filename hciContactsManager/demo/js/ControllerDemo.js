/*
	This is a DEMO version equal to the original, but loading a default contacts list
*/
...
function checkNewSession() {
    ...
    model.checkForSession(function(output){
        ...
        if(obj.id>0){
            ...
            $(".top_bar #session_text").html("<p><b>DEMO  VERSION</b></p>");
